    ...
    <div class="col-md-12 col-sm-12 col-12">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h5 class="card-title m-0"><b>Daftar</b></h5>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="nik" value="<?= old('nik') ?>" class="form-control" type="number" minlength="16" placeholder="NIK">
                    ...
                    <div class="col-sm-12 mt-3">
                        <div class="form-group">
                            <button type="submit" class="btn btn-info btn-flat btn-block"><i class="fas fa-check"></i> Daftar Akun</button>
                        </div>
                    </div>
                </div>
            </div>
